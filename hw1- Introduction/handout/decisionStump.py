...
def output_writer(metric_out,train_error,test_error,train_out,test_out,train_test,test_labels):
...
def predictAndTrainLabel(train_data,train_labels,yes_array,no_array):
    ...
    return maj_vote_yes,maj_vote_no
       
def train_and_test_Output( maj_vote_yes, maj_vote_no,train_labels ):
    ...
    return train_test,test_labels,test_labels_OG
...
if __name__ == "__main__":     
  ...
  # print("The output file is: %s" % (train))
  ...
  #  print(type(split_index))
   ...
   #found the way to open TSV Files -__-
    ...
    '''
    TODO(): 
    change it based on automatic variable (dont use hardcoded text!)
    '''  
    ...
    ''' Prediction of Majority Vote'''
    maj_vote_yes, maj_vote_no = predictAndTrainLabel(train_data,train_labels,yes_array,no_array)
    
    '''Outputs :)'''
    train_test,test_labels,test_labels_OG = train_and_test_Output( maj_vote_yes, maj_vote_no,train_labels )  
 
    '''Error and output writer'''
   
    train_error,test_error = error_calc(train_test,train_labels,test_labels,test_labels_OG)   
    #OutputWriterFunction    
    output_writer( metric_out,train_error,test_error,train_out,test_out,train_test,test_labels )
